        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                ...
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    ...
                    <li class="breadcrumb-item active text-primary">{{__('messages.products.title')}}</li>
                </ol>
            </div>
        </div>
        <!-- Header End -->
    ...
    <div class="container-fluid product py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                <h4 class="text-uppercase text-primary">{{__('messages.products.all')}}</h4>
                <h1 class="display-3 text-capitalize mb-3">{{__('messages.products.subtitle')}}</h1>
            </div>
            ...
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                @if(isset($categories) && $categories->count())
                    @foreach($categories as $category)
                            <a class=" btn btn-{{ $currentCategory == $category->id ? 'secondary' : 'primary' }}"
                ...
                @foreach($products->all() as $product)
                    <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="product-item">
                            <img src="{{ $product->getFirstMediaUrl('images','thumb') }}" class="img-fluid w-100 rounded-top"  alt="Image">
